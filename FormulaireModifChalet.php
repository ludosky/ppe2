    ...
    <body>
           ...
           if(isset($_POST['modif']))
               {
                    ...
                    {                      
                        $m= new Modification();
                        $m->modifChalet($iduse, $_POST['localisation'], $_POST['prixUnitaire'], $_POST['placeMax'], $_POST['nombreLit'], $_POST['nombreChambre']);
                    }
        
                    $reponse=$bdd->query("SELECT * FROM  chalet WHERE numeroChalet=$iduse") or die(mysql_error());
        ...
        <form name="connection" action="FormulaireModifChalet.php" method="post">
                    <center><fieldset style="width:60%;margin-top:10%;color:teal; border: 1px solid teal;">
                        <legend>Modification d'un chalet</legend>
                    Localisation :
